...
const CourseEnrolled = ({ title = "Web Development", level = "Advance", enrolled = 10 }) => {
    return (
        <div className="col-md-6 col-lg-4">
            <div className='card h-100 border-0 course-card' style={{ borderRadius: '20px', transition: 'all 0.4s cubic-bezier(0.16, 1, 0.3, 1)', overflow: 'hidden' }}>
                <div className='card-img-top course-image-wrapper position-relative'>
                    ...
                    <div className="position-absolute bottom-0 start-0 w-100 p-0" style={{ height: '4px', backgroundColor: '#e9ecef' }}>
                        <div style={{ height: '100%', width: '45%', backgroundColor: '#1da599' }}></div>
                    </div>
                </div>
                ...
                <div className="card-footer bg-white border-0 px-4 pb-4 pt-0">
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        <div className="progress-text fw-medium text-muted" style={{ fontSize: '0.9rem' }}>
                            <span style={{ color: '#1da599' }}>45%</span> Completed
                        </div>
                        <div className="actions d-flex gap-2">
                            <Link to="/account/watch-course" className="btn course-btn text-white px-4 py-2 d-flex align-items-center" style={{ fontWeight: '500' }}>
                                <Icon icon="ph:play-circle" className="me-2 fs-5" />
                                Watch
                            </Link>
                        </div>
                    </div>
